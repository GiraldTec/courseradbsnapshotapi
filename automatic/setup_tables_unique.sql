...
DROP TABLE IF EXISTS organization_enrollments;
...
DROP TABLE IF EXISTS eitdigital_course_user_ids;
...
CREATE TABLE peer_reviews (
    ...
    ,eitdigital_peer_assignments_user_id VARCHAR(50) NOT NULL
...
CREATE TABLE programming_submissions (
    ...
    ,eitdigital_programming_assignments_user_id VARCHAR(50) NOT NULL
...
CREATE TABLE discussion_answers (
    ...
    ,eitdigital_discussions_user_id VARCHAR(50) NOT NULL
...
CREATE TABLE feedback_item_comments (
    ...
    ,eitdigital_feedback_user_id VARCHAR(50) NOT NULL
...
CREATE TABLE eitdigital_course_user_ids (
    eitdigital_user_id VARCHAR(50) NOT NULL
...
CREATE TABLE ecb_evaluation_requests (
    course_id VARCHAR(255)
    ,course_item_id VARCHAR(255)
    ,eitdigital_ecb_user_id VARCHAR(50) NOT NULL
    ,ecb_evaluator_id VARCHAR(267)
...
CREATE TABLE assessment_actions (
    ...
    ,eitdigital_assessments_user_id VARCHAR(50) NOT NULL
);
...
CREATE TABLE demographics_answers (
    question_id INT4
    ,eitdigital_demographics_user_id VARCHAR(50) NOT NULL
...
COMMENT ON COLUMN peer_reviews.eitdigital_peer_assignments_user_id IS 'Encrypted Coursera user id for eitdigital peer_assignments data.';
...
';
COMMENT ON COLUMN programming_submissions.eitdigital_programming_assignments_user_id IS 'Encrypted Coursera user id for eitdigital programming_assignments data.';
...
COMMENT ON COLUMN discussion_answers.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
COMMENT ON COLUMN peer_submissions.eitdigital_peer_assignments_user_id IS 'Encrypted Coursera user id for eitdigital peer_assignments data.';
...
COMMENT ON COLUMN feedback_item_comments.eitdigital_feedback_user_id IS 'Encrypted Coursera user id for eitdigital feedback data.';
...
COMMENT ON COLUMN discussion_question_votes.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
COMMENT ON COLUMN peer_skips.eitdigital_peer_assignments_user_id IS 'Encrypted Coursera user id for eitdigital peer_assignments data.';
...
COMMENT ON COLUMN feedback_course_comments.eitdigital_feedback_user_id IS 'Encrypted Coursera user id for eitdigital feedback data.';
...
COMMENT ON COLUMN feedback_course_ratings.eitdigital_feedback_user_id IS 'Encrypted Coursera user id for eitdigital feedback data.';
...
COMMENT ON COLUMN discussion_answer_flags.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
COMMENT ON COLUMN discussion_answer_votes.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
COMMENT ON COLUMN feedback_item_ratings.eitdigital_feedback_user_id IS 'Encrypted Coursera user id for eitdigital feedback data.';
...
COMMENT ON COLUMN discussion_questions.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
Items that have the same id that are in different branches of the same course are considered to be the same for the purposes of progress and grade computations. For example, if you complete item xxxxx in branch A, then you have completed it in branch B even if item xxxxx in branch B is very different from item xxxxx in branch A.';
COMMENT ON COLUMN ecb_evaluation_requests.eitdigital_ecb_user_id IS 'Encrypted Coursera user id for eitdigital ecb data.';
...
COMMENT ON COLUMN peer_comments.eitdigital_peer_assignments_user_id IS 'Encrypted Coursera user id for eitdigital peer_assignments data.';
...
COMMENT ON COLUMN assessment_actions.eitdigital_assessments_user_id IS 'Encrypted Coursera user id for eitdigital assessments data.';
...
COMMENT ON COLUMN discussion_question_followings.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
COMMENT ON COLUMN discussion_question_flags.eitdigital_discussions_user_id IS 'Encrypted Coursera user id for eitdigital discussions data.';
...
COMMENT ON COLUMN demographics_answers.eitdigital_demographics_user_id IS 'Encrypted Coursera user id for eitdigital demographics data.';
